...
},
{
  ...
  duration: "23m",
  description: "Se celebra la Conferencia Internacional de Gremios en Estados Unidos. Jinwoo es invitado, pero los cazadores de todo el mundo no son los únicos interesados en él.",
...
},
{
  ...
  duration: "23m",
  description: "Durante la conferencia, un portal de rango S se abre inesperadamente en Japón. Jinwoo decide intervenir, mostrando al mundo el verdadero poder del Monarca de las Sombras.",
...
},
{
  ...
  duration: "23m",
  description: "Después de conquistar la mazmorra de rango S en Japón y derrotar al rey de los gigantes, Beru, Jinwoo se convierte oficialmente en el décimo cazador de rango S de Corea.",
...
},
{
  ...
  duration: "23m",
  description: "Los Monarcas, los verdaderos enemigos, comienzan a moverse. Jinwoo descubre la verdad sobre el Sistema y su papel en la guerra eterna entre los Monarcas y los Gobernantes.",
...
},
{
  ...
  title: "Valió la pena.",
  duration: "23m",
  description: "Jinwoo se enfrenta a los Monarcas de las Plagas, las Bestias y la Escarcha. Es una batalla desesperada en la que debe usar todo su poder para proteger a sus seres queridos.",
...
},
{
  ...
  duration: "23m",
  description: "El mundo está al borde de la destrucción. Jinwoo, ahora con el corazón negro y el poder completo del Monarca de las Sombras, se prepara para la batalla final contra Antares, el Rey de los Dragones.",
...
},
{
  ...
  duration: "23m",
  description: "La guerra contra los Monarcas llega a su punto culminante. Jinwoo y su ejército de 10 millones de sombras se enfrentan al ejército de destrucción de Antares.",
...
},
{
  ...
  duration: "23m",
  description: "Después de una batalla épica, Jinwoo derrota a Antares. Con la guerra terminada, los Gobernantes le ofrecen una elección: vivir en el mundo restaurado o usar la Copa de la Reencarnación para retroceder en el tiempo.",
...
},
{
  ...
  duration: "23m",
  description: "Jinwoo elige retroceder el tiempo y libra la guerra contra los Monarcas solo durante 27 años en una dimensión diferente. Regresa a un mundo en paz, donde solo él recuerda los eventos pasados, listo para vivir una vida normal.",
